...
2) From version 1.1.0, users are allowed to input a pair file as a complementary for LTS-RTS pair information. This will help a lot to search for HLEs in close species. More information see (#usage).
# Dependencies
```
- python = 3.9.0
- r-base = 4.1
