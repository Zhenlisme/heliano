...
Perform the following code. (note: the `genome.fa` is the only input that is the genome file of Xenopus tropicalis in fasta format. The main result could be found in file **RC.representative.bed** in **HELIANO_opt** directory.)   
